...
def main():
    ...
    parser_script1 = subparsers.add_parser('bkp', help='Detect HGT breakpoints from metagenomic sequencing data.', add_help=False, formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser_script2 = subparsers.add_parser('event', help='Infer complete HGT events based on detected HGT breakpoints.', add_help=False, formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    required2.add_argument("-b", type=str, help="<str> Folder saves all the breakpoint results from all samples.", metavar="\b")
