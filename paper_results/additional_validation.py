#!/usr/bin/env python3
"""
Get information on the independent CRC cohort to validate the CRC classifier
"""
...
from CRC_LODO_Analysis_v2 import Sample, Taxonomy
...
if __name__ == "__main__":
    ...
    ### the validation folder can be found in meta_data/validation.zip
    meta_file = "validation/last_gutmeta_sample.tsv"  # metadata
    result_list = "validation/wenkui.list"  # a list file record the HGT breakpoint result file of each sample
    abundance_dir = "validation/wenkui_metaphlan3/" # abundance result of each sample

    marker_genus, select_edges = read_markers()  # read the markers generated by CRC_LODO_Analysis_v2.py
    taxonomy = Taxonomy()
