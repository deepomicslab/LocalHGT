"""
to test whether the mechanism frequency differs between different taxonomy lineages
"""
...
class Taxonomy():
    ...
    def get(self, save_file = "/mnt/d/breakpoints/script/analysis/taxonomy_dict.pkl"):
...
if __name__ == "__main__":
    ...
    UHGG_meta = "/mnt/d/breakpoints/HGT/UHGG/genomes-all_metadata.tsv" ## obtained at https://ftp.ebi.ac.uk/pub/databases/metagenomics/mgnify_genomes/human-gut/v1.0/genomes-all_metadata.tsv
    mechanism_result = "/mnt/d/HGT/time_lines/mechanism_result.txt" # mechanism_result generated by mechanism.py
