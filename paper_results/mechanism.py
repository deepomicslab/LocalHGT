...
"""
Assign the mutational mechanism for HGT events
"""
...
if __name__ == "__main__":
    ...
    result_dir = "/mnt/delta_WS_1/wangshuai/02.HGT/detection/Hybrid/hgt/result/"  # HGT breakpoint results of the hybrid cohorts (SRP366030) detected by LocalHGT, can be downloaded from https://doi.org/10.5281/zenodo.10906354
    bkp_dir = result_dir
    database_dir = "/mnt/delta_WS_1/wangshuai/02.HGT/detection/reference/" # folder to store UHGG reference and the annotation files
    ...
    verified_result = "/mnt/delta_WS_1/wangshuai/02.HGT/detection/Hybrid/match/SRP366030.verified_event.csv" # verified HGT events in the hybrid cohorts (SRP366030), generated by validate_bkp_match.py

    mechanism_result = result_dir + "/mechanism_result.txt" # to store the assigned mechanisms
